...
public class ProductTypeAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<Data> datas;
    public ProductTypeActivity context;
    private int type=0;
    ...
    private ProductTypeAdapter.OnitemClickListener onitemClickListener=null;
    @SuppressLint("WrongConstant")
    public ProductTypeAdapter(ProductTypeActivity context1, List<Data>data){
    ...
    public void setOnitemClickListener(ProductTypeAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.producttype_data_xml, parent, false);
            ProductTypeAdapter.LinearViewHolder linearViewHolder = new ProductTypeAdapter.LinearViewHolder(baseView);
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.producttype_data_xml, parent, false);
            ProductTypeAdapter.GridViewHolder gridViewHolder = new ProductTypeAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final ProductTypeAdapter.LinearViewHolder linearViewHolder= (ProductTypeAdapter.LinearViewHolder) holder;
            ...
            linearViewHolder.edit_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
//新增信息
                    Intent intent=new Intent(context,AddProductTypeActivity.class);
        ...
        normalDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //...To-do
                        new HttpUtils().Post(Constant.APPURLS+"/product/producttype/delete"+"/"+id,token,new HttpUtils.HttpCallback() {
