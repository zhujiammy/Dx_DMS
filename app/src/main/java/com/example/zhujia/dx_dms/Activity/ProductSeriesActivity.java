...
import com.example.zhujia.dx_dms.Adapter.ProductSeriesAdapter;
...
public class ProductSeriesActivity extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private ProductSeriesAdapter adapter;
    private  int total;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productaeries_xml);
        intent=getIntent();
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new ProductSeriesAdapter(this,getData());
    ...
    private void loaddata(){
        ...
        try {
            pager.put("likeSeriesName","");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        String json=pager.toString();
        String params="currentPage="+pageindex+"&"+"pageSize="+"15"+"&"+"sortName="+"id"+"&"+"sortType="+"desc";
        new HttpUtils().postJson(Constant.APPURLS+"product/productseries/page?"+params,json,token,new HttpUtils.HttpCallback() {
    ...
    private void fillDataToList(JSONObject data) throws JSONException {
        ...
        if(!data.isNull("rows")){
            ...
            for(int i=0;i<contentjsonarry.length();i++){
                ...
                rechargData.setSeriesName(object.getString("seriesName"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            Toast.makeText(ProductSeriesActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.add){
            //新增信息
            intent=new Intent(this,AddProductSeriesActivity.class);
