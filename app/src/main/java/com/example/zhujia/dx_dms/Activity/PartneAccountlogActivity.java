...
public class PartneAccountlogActivity extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 7:
                            ...
                            break;
                        default:
                            Toast.makeText(PartneAccountlogActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
