...
public class AddProductTypeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addproducttype_xml);
    ...
    private void loadGet(String id){
        System.out.print(id);
        new HttpUtils().Post(Constant.APPURLS+"product/producttype/get"+"/"+id,token,new HttpUtils.HttpCallback() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.save_btn){
            ...
            try {
                object.put("typeName",typeName.getText().toString());
            } catch (JSONException e) {
                e.printStackTrace();
            }
            String params=object.toString();
            //保存
            if(TextUtils.isEmpty(typeName.getText().toString())){
                Toast.makeText(getApplicationContext(),"类型不能为空",Toast.LENGTH_SHORT).show();
            }else if(intent.getStringExtra("type").equals("2")) {
                //修改
                new HttpUtils().postJson(Constant.APPURLS + "product/producttype/update" + "/" + intent.getStringExtra("id"),params,token, new HttpUtils.HttpCallback() {
                ...
                new HttpUtils().postJson(Constant.APPURLS+"product/producttype/add",params,token,new HttpUtils.HttpCallback() {
                ...
                switch (msg.what) {
                    ...
                    case 0:
                        ...
                        if(reslutJSONObject.getString("code").equals("200")){
                            Toast.makeText(AddProductTypeActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        typeName.setText(object.getString("typeName"));
                        break;
                    default:
                        Toast.makeText(AddProductTypeActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                        break;
                }
            }catch (JSONException e){
                e.printStackTrace();
