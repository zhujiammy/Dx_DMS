...
import com.example.zhujia.dx_dms.Adapter.Companyinformation_Adapter;
...
public class CompanyinformationActivity extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private Companyinformation_Adapter adapter;
    private  int total;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loaddata();//加载列表数据
        loadstatue();
        adapter=new Companyinformation_Adapter(this,getData());
    ...
    private void  loadstatue(){
        new HttpUtils().Post(Constant.APPURLS+"group/groupcompany/query/status",token,new HttpUtils.HttpCallback() {
            @Override
            public void onSuccess(String data) {
                // TODO Auto-generated method stub
                com.example.zhujia.dx_dms.Tools.Log.printJson("tag",data,"header");
    ...
    private void loaddata(){
        ...
        new HttpUtils().postJson(Constant.APPURLS+"group/groupcompany/page?"+params,json,token,new HttpUtils.HttpCallback() {
    ...
    private void fillDataToList(JSONObject data) throws JSONException {
        ...
        if(!data.isNull("rows")){
            ...
            for(int i=0;i<contentjsonarry.length();i++){
                ...
                rechargData.setCompanyCode(object.getString("companyCode"));
                rechargData.setCompanyName(object.getString("companyName"));
                rechargData.setShortName(object.getString("shortName"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 6:
                            ...
                            break;
                        default:
                            Toast.makeText(CompanyinformationActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.add){
            //新增信息
            intent=new Intent(this,AddCompanyinformation_Activity.class);
