...
public class PartnerbankActivity extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private void loaddata(){
        ...
        new HttpUtils().postJson(Constant.APPURLS+"partner/partnerbank/page?"+params,json,token,new HttpUtils.HttpCallback() {
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 7:
                            ...
                            break;
                        default:
                            Toast.makeText(PartnerbankActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
